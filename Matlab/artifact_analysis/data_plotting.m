...
for file_idx = 1:num_files
    ...
    try
        ...
        visualize_eeg_evoked(EEG, ...
            ...
            'TimeLimits', [-100, 400], ...
            'AmplitudeLimits', [-100, 100], ...
            'PlotTitle', sprintf('TMS-evoked potentials - %s', current_datasets_savename), ...
            'SaveFig', true, ...
            'OutputPath', current_output_folder, ...
            'Filename', [current_datasets_savename '_evoked_potentials'], ...
            'TitleInterpreter', 'none');
        
        % Generate four-channel TMS-evoked potential plot (C5, C3, C1, Cz)
        visualize_eeg_evoked(EEG, ...
            'BaselineWindow', demeaning_interval, ...
            'TimeLimits', [-100, 400], ...
            'AmplitudeLimits', [-100, 100], ...
            'PlotTitle', sprintf('TMS-evoked potentials (Central channels) - %s', current_datasets_savename), ...
            'ChannelNames', {'C5', 'C3', 'C1', 'Cz'}, ...
            'SaveFig', true, ...
            'OutputPath', current_output_folder, ...
            'Filename', [current_datasets_savename '_evoked_potentials_central'], ...
            'TitleInterpreter', 'none');
